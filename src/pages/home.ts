          ...
          ${demos
            .map((demo) => {
              ...
              const thumb = demo.referenceImage
                ? `<span class="card-thumb has-img" style="--accent:${demo.accent}"><img src="${demo.referenceImage}" alt="" onerror="var p=this.parentElement; if(p){p.classList.remove('has-img'); p.textContent='${demo.thumbLabel}';}" /></span>`
